...
function showCalendar(t) { $("#ndp-nepali-box table").find("tr:gt(0)").remove(), "" == t ? $("#ndp-nepali-box table").append(getDateTable("")) : $("#ndp-nepali-box table").append(getDateTable(t)), "block" == $("#ndp-nepali-box").css("display") && $("#ndp-nepali-box").hide(), $("#ndp-nepali-box").fadeIn(100); }

function getDateTable(t) {
    if ("" == t) {
        var e = getNepaliDate(), s = getMonthParameters(e), a = getDateRows(s[0], s[1], s[2], s[3], s[4]);
        return a;
    }
    var s = getMonthParameters(t), a = getDateRows(s[0], s[1], s[2], s[3], s[4]);
    return a;
}

function getMonthParameters(t) {
    var e = t.split("-"), s = e[0], a = e[1];
...
function getDateRows(t, e, s, a, n) {
   ...
   // t -= 3;
    ...
    var r = getNepaliDate(), i = r.split("-");
    i[0];
    for (var h = get2DigitNo(i[1]), d = get2DigitNo(i[2]), o = "", b = 0; t + e > b; b++) {
        0 == b % 7 && (o += "<tr>");
        var u = b - t + 1, c = "" + s + "-" + get2DigitNo(a) + "-" + get2DigitNo(u), l = "";
        l = get2DigitNo(a) == h && d == get2DigitNo(u) ? "ndp-selected" : u == n ? "ndp-current" : "ndp-date", t > b ? o += "<td></td>\n" : (o += "<td class='" + l + "'>", o += "<a href='javascript:void(0)' onclick=\"setSelectedDay('" + c + "')\">" + englishNo2Nep(u) + "</a>", o += "</td>\n"), 6 == b % 7 && (o += "</tr>\n");
    }
    return o;
}

function hideCalendarBox() { $("#ndp-nepali-box").fadeOut(100); }

function get2DigitNo(t) { return t = parseInt(t, 10), 10 > t ? "0" + ("" + t) : "" + t; }
...
function getCurrentDayName() {
    var t = new Date, e = t.getDay(), s = Array(7);
    return s[0] = "Sunday", s[1] = "Monday", s[2] = "Tuesday", s[3] = "Wednesday", s[4] = "Thursday", s[5] = "Friday", s[6] = "Saturday", s[e];
}

function getDayFromDate(t) {
    var e = t.split("-"), s = e[2], a = e[1], n = e[0], r = new Date(n, a - 1, s), i = r.getDay(), h = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
    return h[i];
}

function numberOfBsDays(t, e) {
    var s = new NepaliDateConverter;
    return s.bs[t][e];
}

function numberOfDays(t, e) {
    var s = new Date(t, e, 0);
    return s.getDate();
}
...
function getDateInWords() {
    var t = getMonths(), e = new Date, s = e.getDate(), a = e.getMonth() + 1, n = e.getYear(), r = 1e3 > n ? n + 1900 : n;
    return s + " " + t[a] + ", " + r;
}

function getDateInNo(t) {
    var e = new Date, s = e.getDate(), a = e.getMonth() + 1, n = e.getFullYear();
    return a + t + s + t + n;
}

function getAdDateInWords(t) {
    var e = getMonths(), s = t.split("-"), a = s[2], n = s[1], r = s[0];
    return a + " " + e[n] + ", " + r;
}

function getNepaliDateInWords(t) {
    var e = getNepaliMonths(), s = t.split("-"), a = s[2], n = s[1], r = s[0];
    return a + " " + e[n] + ", " + r;
}
...
function makeArray() { for (i = 0; makeArray.arguments.length > i; i++) this[i + 1] = makeArray.arguments[i]; }
...
function NepaliDateConverter() {
    this.bs_date_eq = "01/18/2000", this.ad_date_eq = "05/01/1943", this.bs = [],


//    this.bs[1970] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1971] = [31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30],
//    this.bs[1972] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30],
//    this.bs[1973] = [30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],
//    this.bs[1974] = [31, 31, 32, 30, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1975] = [31, 31, 32, 32, 30, 31, 30, 29, 29, 29, 30, 30],

//    this.bs[1976] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31],
//    this.bs[1977] = [31, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31],
//    this.bs[1978] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1979] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30],
//    this.bs[1980] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31],

//    this.bs[1981] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30],
//    this.bs[1982] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1983] = [31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30],
//    this.bs[1984] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31],
//    this.bs[1985] = [31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30],



//    this.bs[1986] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1987] = [31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30],
//    this.bs[1988] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31],
//    this.bs[1989] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1990] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],

//    
//    this.bs[1991] = [31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30],
//    this.bs[1992] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],
//    this.bs[1993] = [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1994] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1995] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30],

//    this.bs[1996] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],
//    this.bs[1997] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1998] = [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],
//    this.bs[1999] = [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31],
...
function count_ad_days(t, e) {
    var s = 864e5, a = t.split("/"), n = e.split("/");
...
function count_bs_days(t, e) {
    var s = t.split("/"), a = e.split("/"), n = Number(s[2]), r = Number(s[0]), i = Number(s[1]), h = Number(a[2]), d = Number(a[0]), o = Number(a[1]), b = 0, u = 0;
