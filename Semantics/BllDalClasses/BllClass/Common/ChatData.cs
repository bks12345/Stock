...
namespace ChatterData
{
    ...
    {
        //private clsCommonDal clsConn = new clsCommonDal();
        private static string m_ConnectionString = "Server=WIN-DXJHWXARWRD;Database=dbensure;User ID=sa;pwd=dbsecret";
        ...
        public DataTable GetMessages()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Chatter_GetMessages", m_sqlConn);
