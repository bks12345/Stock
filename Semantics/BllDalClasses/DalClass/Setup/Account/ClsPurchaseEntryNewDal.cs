...
{
    public class ClsPurchaseEntryNewDal
    {
        clsCommonDal objCmnDal = new clsCommonDal();
        public DataTable GetPurchaseItem(ClsPurchaseEntryNewBll objbll)
        {
        ...
        public DataTable GetPurchaseDetails(ClsPurchaseEntryNewBll objbll)
        {
            SqlParameter[] sqlparam = new SqlParameter[1];
        ...
        public DataSet GetAllPurchasedetails(ClsPurchaseEntryNewBll objbll)
        {
            ...
            ds = objCmnDal.GetTableSet("GET_PURCHASEENTRY_DETAILS", "sp", sqlparam);
            return ds;
        }
        public string InsertUpdate_PurchaseEntry(ClsPurchaseEntryNewBll obj)
        {
            SqlParameter[] sqlparam1 = new SqlParameter[32];
            ...
            sqlparam1[28] = new SqlParameter("@DiscRate", SqlDbType.Decimal);
            sqlparam1[28].Value = NullHandler.Decimal(obj.pdiscRate);

            sqlparam1[29] = new SqlParameter("@pTdsAmt", SqlDbType.Decimal);
            sqlparam1[29].Value = NullHandler.Decimal(obj.pTdsAmt);
            sqlparam1[30] = new SqlParameter("@pTdsRate", SqlDbType.Decimal);
            sqlparam1[30].Value = NullHandler.Decimal(obj.pTdsRate);
            sqlparam1[31] = new SqlParameter("@ptdsGLcode", SqlDbType.VarChar);
            sqlparam1[31].Value = NullHandler.String(obj.ptdsGLcode);
            objCmnDal.InsertUpdateTable("INSERTUPDATE_PURCHASEENTRY_DETAILS", "sp", sqlparam1);
            if (sqlparam1[15].Value != DBNull.Value)
                return sqlparam1[15].Value.ToString();
            else
                return null;
        }
        public DataTable GetVendordetails(ClsPurchaseEntryNewBll objbll)
        {
            SqlParameter[] sqlparam = new SqlParameter[1];
