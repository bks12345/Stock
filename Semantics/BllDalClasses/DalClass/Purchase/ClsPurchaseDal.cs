...
{
    public class ClsPurchaseDal
    {
        clsCommonDal objCmnDal = new clsCommonDal();
        public DataTable GetPurchaseItem(ClsPurchaseBll objbll)
        {
        ...
        public DataTable GetPurchaseDetails(ClsPurchaseBll objbll)
        {
            SqlParameter[] sqlparam = new SqlParameter[1];
        ...
        public DataSet GetAllPurchasedetails(ClsPurchaseBll objbll)
        {
        ...
        public string InsertUpdate_PurchaseEntry(ClsPurchaseBll obj)
        {
        ...
        public DataTable GetVendordetails(ClsPurchaseBll objbll)
        {
            SqlParameter[] sqlparam = new SqlParameter[1];
