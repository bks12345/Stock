<%@ Page Title="" Language="C#" MasterPageFile="~/Stock/main.Master" AutoEventWireup="true" CodeBehind="SalesEntry.aspx.cs" Inherits="Stock.Stock.Process.SalesEntry" %>
    ...
    <div class="row fixed-header">
        <div class="col-sm-12 col-md-12">
            <div class="page-header-container">
                <h4 class="page-header" style="margin-bottom: 0!important;">Sales Entry</h4>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:Panel ID="pnlEntry" runat="server">
                                ...
                                <div class="form-group" style="border-top: 1px solid rgb(204, 204, 204); padding-top: 6px; margin-top: 11px ! important;">
                                    <asp:Label ID="Label6" runat="server" Text="Sales Date" CssClass=" col-md-4 col-sm-4 col-xs-12 control-label"></asp:Label>
                                ...
                                <div class="form-group">
                                    <asp:Label ID="Label27" runat="server" Text="Sales Type" CssClass=" col-md-4 col-sm-4 col-xs-12 control-label"></asp:Label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <asp:DropDownList ID="ddlPurchaseType" runat="server" CssClass="form-control" TabIndex="3">
                                            <asp:ListItem Value="-1">None</asp:ListItem>
                                            <asp:ListItem Value="0">Wholesale</asp:ListItem>
