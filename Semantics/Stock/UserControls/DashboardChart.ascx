<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DashboardChart.ascx.cs" Inherits="Stock.Ensure.UserControls.DashboardChart" %>
...
.dash-text {color:#aaa; border-bottom:1px solid #aaa;}
.dash-image {height: 112px;overflow: hidden;width: 112px;margin-left: 37%;margin-top: 8px;}
.dash-image > img {width:100%; height: auto;}
 @media (max-width: 800px)
{
.dash-padding {padding-left: 50px;}
}
</style>

       <div class="form-group dash-text">
    <div class="col-md-2 col-xs-12 col-sm-2">
    <div class="form-group">
        <div class="col-md-12 col-xs-12 col-sm-12">
        <div class="dash-image text-center">
            <img src="../../Design/img1/dash-user.jpg" />
        </div>
        </div>
    </div>
    </div>
    <div class="col-md-3 col-sm-4 col-xs-12 dash-padding">
    <div class="form-group">
        <div class="col-md-12 col-xs-12 col-sm-12">
    ...
    <div class="form-group">
        <div class="col-md-12 col-xs-12 col-sm-12">
        <asp:Label ID="Label3" runat="server" Text="Telephone:" CssClass="control-label"></asp:Label>
        </div>
        </div>
    <div class="form-group">
        <div class="col-md-12 col-xs-12 col-sm-12">
    ...
    <div class="form-group">
        <div class="col-md-12 col-xs-12 col-sm-12">
        <asp:Label ID="Label5" runat="server" Text="Target:" CssClass="control-label"></asp:Label>
        </div>
        </div>
    <div class="form-group">
        <div class="col-md-12 col-xs-12 col-sm-12">
        <asp:Label ID="Label6" runat="server" Text="Total Business:" CssClass="control-label"></asp:Label>
    </div>
    </div>
        ...
        <script src="../../Design/amcharts/amcharts.js" type="text/javascript"></script>
        <script src="../../Design/amcharts/serial.js" type="text/javascript"></script>
               ...
               <script type="text/javascript">
                ...
                },
                {
                   ...
                   AmCharts.ready(function () {
                       ...
                       chart5.addValueAxis(distanceAxis);
                       ...
                       chart5.addValueAxis(latitudeAxis);
                       ...
                       chart5.addValueAxis(durationAxis);
