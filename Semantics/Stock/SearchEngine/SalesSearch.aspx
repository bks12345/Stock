<%@ Page Title="" Language="C#" MasterPageFile="~/Stock/main.Master" AutoEventWireup="true" CodeBehind="SalesSearch.aspx.cs" Inherits="Stock.Stock.SearchEngine.SalesSearch" %>
    ...
    <div class="row fixed-header">
        <div class="col-sm-12 col-md-12">
            <div class="page-header-container">
                <h4 class="page-header" style="margin-bottom: 0!important;">Sales Search</h4>
            </div>
        </div>
    </div>
                                        ...
                                        <table id="rpt" class="stripe row-border order-column" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <asp:Label ID="Label19" runat="server" Text="Sales Type" Width="100px"></asp:Label>
                                                    </th>
                                                    <th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rptpurchasedetail" runat="server">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr onmousedown="HideMenu('contextMenu');" onmouseup="HideMenu('contextMenu');" oncontextmenu="ShowMenu('contextMenu',event,'<%#Eval("salesid") %>');">
                                                            <td>
                                                                <asp:Label ID="lblSno" runat="server" Text='<%#Eval("ROWNUMBER") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lblInsuredName" runat="server" Text='<%#Eval("salesid") %>'></asp:Label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label18" runat="server" Text='<%#Eval("salestype") %>'></asp:Label>
                                                            </td>
                                                            <td>
